...
import java.sql.*;
public class A_05_Student_Details_1 extends JFrame implements ActionListener {
    ...
    JRadioButton jb9; JRadioButton jb10; JRadioButton jb11;

    JComboBox st; JComboBox rl; JComboBox ct; JComboBox dep; JComboBox course;
    JButton next; JButton close;
    A_05_Student_Details_1() {
        setSize(1150, 900);
        setLayout(null);
        setVisible(true);
        setLocationRelativeTo(null);
        setTitle("Shobhit University Gangoh : Personal Details");
        getContentPane().setBackground(Color.WHITE);

        JLabel tittle = new JLabel("New Student's Personal Details");
        tittle.setBounds(350, 00, 500, 40);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == next) {
            try {
                ...
                String Religion = (String) rl.getSelectedItem();
                String Category = (String) ct.getSelectedItem();
                ...
                String Admissionquota = null;
                if (jb6.isSelected()) {
                    Admissionquota = "Counselling";
                }
                if (jb7.isSelected()) {
                ...
                if (Admissionno.equals("")) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please Select Any Gender Option");
                    ...
                    JOptionPane.showMessageDialog(null, "Please Select Any State");
                } else if (Religion.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Select Any Religion");
                ...
                } else if (Admissiontype.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Select Admission Type");
                } else if (Admissionquota.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Select Admission Quota");
                } else if (Transportation.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Select a Option of Transportation Required");
                } else if (Hostel.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Select a Option of Hostel Required");
                }
                try {
...
//                    Connection conn = ConnectionProvider.getConnnection();
                    String q = "insert into Student_Details_1 value('" + Admissionno + "','" + Enrolment + "','" + Rollno + "','" + FirstName + "','" + LastName + "','" + Email + "','" + Contactno + "','" + DOB + "','" + Gender + "','" + Aadhaarno + "','" + Address + "','" + City + "','" + Pincode + "','" + State + "','" + Religion + "','" + Category + "','" + Department + "','" + Course + "','" + Branch + "','" + Admissiontype + "','" + Admissionquota + "','" + Transportation + "','" + Hostel + "')";
                    ...
                    JOptionPane.showMessageDialog(null, "Student's Personal Details Stored Securely");

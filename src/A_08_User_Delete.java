...
import java.sql.*;
public class A_08_User_Delete extends JFrame implements ActionListener {
    ...
    A_08_User_Delete() {
        ...
        setTitle("Shobhit University Gangoh : Delete user's Details");
        ...
        JLabel tittle = new JLabel("Delete User's Details");
        tittle.setBounds(200, 40, 500, 40);
        ...
        il1.setBounds(100,40,size.width, size.height);
...
//                    Connection conn = DriverManager.getConnection(url, username, password);
                    Connection conn = ConnectionProvider.getConnnection();
                    String q1 = "delete from UserSignUp where User_ID = '" + ID + "'";
                    Statement stmt = conn.createStatement();
                    ...
                    JOptionPane.showMessageDialog(null, "User's Details Deleted Securely");
                }catch (Exception ex)
                {
                    ex.printStackTrace();
                }

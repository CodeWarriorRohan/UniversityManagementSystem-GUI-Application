...
public class A_03_UserSignUp extends JFrame implements ActionListener
{
    ...
    A_03_UserSignUp()
    {
        ...
        setTitle("Shobhit University Gangoh : User SignUp Page");
        getContentPane().setBackground(Color.WHITE);

        Container c = getContentPane();
        JLabel il1 = new JLabel();
        il1.setIcon(new ImageIcon("src/Images/admin_signup2.jpg"));
        Dimension size = il1.getPreferredSize();
        il1.setBounds(40,30,size.width, size.height);

        JLabel tittle = new JLabel("New User Details");
        tittle.setBounds(230, 30, 500, 40);
        ...
        pf5.setFont(new Font("arial",Font.BOLD,18));
        ...
        pf6.setFont(new Font("arial",Font.BOLD,18));
        ...
        if (e.getSource() == submit) {
            try {
                ...
                if (ID.equals("")) {
                    ...
                    JOptionPane.showMessageDialog(null,"Please Check your contact no.\nContact no. is not valid");
                }if (Password.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Create a strong password");
                }if(Password.length() < 6) {
                    JOptionPane.showMessageDialog(null,"Password should be of minimum 6 digits");
                }if (Conpassword.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please Confirm your password");
                }if (!Password.equals(Conpassword)) {
                    JOptionPane.showMessageDialog(null, "Your confirm password not matched \n Please Re-check");
                }
                try {
...
//                    Connection conn = DriverManager.getConnection(url,username,password);
                    ...
                    String q = "insert into UserSignUp value('" +ID+ "','" + Name + "','" + Email + "','" + Contact + "','" + Password + "','" + Conpassword + "')";
                    Statement stmt = conn.createStatement();
                    stmt.executeUpdate(q);
                    System.out.println("Database connected..");
                    System.out.println("Your data has been inserted..");

                    JOptionPane.showMessageDialog(null, "Your user account is created successfully");
                    setVisible(false);

...
import java.sql.*;
public class A_12_Forget_Password_A extends JFrame implements ActionListener
{
    ...
    A_12_Forget_Password_A()
    {
        setSize(750,768);
        setLayout(null);
        setVisible(true);
        setLocationRelativeTo(null);
        setTitle("Shobhit University Gangoh : Admin Re-SignUp Page");
        getContentPane().setBackground(Color.WHITE);

        JLabel tittle = new JLabel("Re-Create Admin Account");

...
import java.sql.*;
public class A_08_Student_Delete extends JFrame implements ActionListener {
    JLabel l1; JLabel l2; JLabel l3; JLabel l4; JLabel l5;
    JLabel l6; JLabel l7; JLabel l8; JLabel l9; JLabel l10;
    JLabel l11; JLabel l12; JLabel l13; JLabel l14; JLabel l15;
    JLabel l16; JLabel l17; JLabel l18; JLabel l19; JLabel l20;
    JLabel l21; JLabel l22; JLabel l23;
    ...
    JComboBox st; JComboBox rl; JComboBox ct; JComboBox dep;
    JComboBox course; JButton next; JButton close;
    A_08_Student_Delete() {
        setSize(1160, 900);
        setLayout(null);
        setVisible(true);
        setLocationRelativeTo(null);
        setTitle("Shobhit University Gangoh : Delete Student's Personal Details");
        ...
        JLabel tittle = new JLabel("Delete Student's Personal Details");
        tittle.setBounds(150, 00, 500, 40);
        tittle.setFont(new Font("arial", Font.BOLD, 30));

        Container c = getContentPane();
        JLabel il1 = new JLabel();
        il1.setIcon(new ImageIcon("src/Images/delete1.jpg"));
        Dimension size = il1.getPreferredSize();
        il1.setBounds(50,0,size.width, size.height);
...
//                    Connection conn = ConnectionProvider.getConnnection();
                    ...
                    String q = "delete from Student_Details_1 where Roll_no = '" + Rollno + "'";
                    Statement stmt = conn.createStatement();
                    stmt.executeUpdate(q);

                    String q1 = "delete from Student_Details_2 where Roll_no = '" + Rollno + "'";
                    Statement stm = conn.createStatement();
                    stm.executeUpdate(q1);

                    String q2 = "delete from Student_Details_3 where Roll_no = '" + Rollno + "'";
//                    String q2 = "update Student_Details_3 set 10th_Obtained_Marks = '" + tenMarks + "',10th_Board = '" + tenBoard + "',12th_Obtained_Marks = '" + twlMarks + "',12th_Board = '" + twlBoard + "',Diploma_Branch = '" + dipbranch +"',Diploma_Obtained_Marks = '" + dipMarks + "',Graduation_Obtained_Marks = '" + graduMarks + "'  where Roll_no = '" + Rollno + "'";
                    ...
                    setVisible(false);
//                    new Student_Delete_2(Rollno).setVisible(true);
                    JOptionPane.showMessageDialog(null, "Student's Personal, Parent and Educational Details Deleted Securely");
                } catch (Exception ex1) {
                    ex1.getStackTrace();
                }
            } catch (Exception ex2) {

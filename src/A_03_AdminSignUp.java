...
import java.sql.*;
public class A_03_AdminSignUp extends JFrame implements ActionListener
{
    ...
    A_03_AdminSignUp()
    {
        ...
        setTitle("Shobhit University Gangoh : Admin SignUp Page");
        ...
        JLabel tittle = new JLabel("New Admin Details");
...
//                    Connection conn = DriverManager.getConnection(url,username,password);
                    ...
                    setVisible(false);
//                    new A_03_AdminSignUp().setVisible(true);
                } catch (Exception ex1) {
                    ex1.getStackTrace();
                }
